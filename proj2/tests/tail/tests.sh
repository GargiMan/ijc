...
tests=('n+1tf' 'n3tf' 'n+3tf' 'tf' 'ml' 'n+750ml' 'n150ml' 'n2last' \
'n+1tf.stdin' 'n3tf.stdin' 'n+3tf.stdin' 'tf.stdin' 'ml.stdin' 'n+750ml.stdin' \
'n150ml.stdin' 'n2last.stdin' 'n+0tf' 'n+0tf.stdin')
if [ -z $1 ]; then
